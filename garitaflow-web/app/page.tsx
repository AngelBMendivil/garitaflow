...
const PORT_ORDER = [
  'SAN_YSIDRO', 'OTAY',               // Tijuana (PED_WEST se inyecta en SAN_YSIDRO)
  'TECATE',                            // Tecate
  'MEXICALI1', 'MEXICALI2',           // Mexicali
  'NOGALES1', 'NOGALES2',             // Nogales
  'ELPASO1', 'ELPASO2', 'ELPASO3',   // Cd. Juárez
  'LAREDO1', 'LAREDO2',              // Nuevo Laredo
]
